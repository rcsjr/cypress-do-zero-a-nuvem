describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  //Exercício extra 7.3
  it('envia o formuário com sucesso usando um comando customizado parte 3', () => {
    cy.clock()
    cy.fillMandatoryFieldsAndSubmit()
...
it('preenche o campo da área de texto usando o comando invoke', () =>{
  cy.get('#open-text-area').invoke('val', 'Texto teste')
    .should('have.value', 'Texto teste')
  cy.get('#firstName').invoke('val', 'Robson')
    .should('have.value', 'Robson')
  cy.get('#lastName').invoke('val', 'Junior')
    .should('have.value', 'Junior')
  cy.get('#email').invoke('val', 'robson@teste.com')
    .should('have.value', 'robson@teste.com')
})
//Exercício extra 4
